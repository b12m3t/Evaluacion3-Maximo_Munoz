...
# Fase de la ruta raíz (Puerto 5500)
@app.route('/')
def index():
    return 'Bienvenido a la Evaluacion 3 de Redes Avanzadas!'

# Almacenar credenciales usando SHA256
...
# Verificar credenciales leyendo parámetros HTTP
...
def login():
    ...
    if request.method == 'POST':
        if verify_hash(request.form['username'], request.form['password']):
            ...
            error = 'Nombre de usuario/contrasena no valida\n'
    else:
